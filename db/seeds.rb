...
puts 'create des users sans assos'
...
event_3 = Event.new(name: 'Atelier restauration vélos', description: 'Venez nous aider à remettre en état des vélo', address: '58 Rue Damesme, 75013 Paris', cause:  Event::EVENT_CAUSES[2], start_date: 'Sat, 12 Mar 2022 10:00:00 +0100', end_date:'Sat, 12 Mar 2022 17:00:00 +0100', number_volunteers: 10, asso: Asso.find_by(name: 'Le Petit Biclou'), status: 1)
