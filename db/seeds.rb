...
sum_hours(event_3)
event_4 = Event.new(name: 'Cours de français', description: 'Apprendre à parler français à un groupe de 10 personnes', address: '23 Rue Clovis, 75005 Paris', cause:  Event::EVENT_CAUSES[2], start_date:'Wed, 7 Sep 2022 11:00:00 +0100', end_date: 'Wed, 7 Sep 2022 13:00:00 +0100', number_volunteers: 1, asso: Asso.find_by(name: 'Atouts Cours'))
assign_photo_event(event_4, ["https://cdn.paris.fr/paris/2020/03/31/huge-ffafc7d5aa953d87761152c593c462b1.jpg"])
sum_hours(event_4)
event_5 = Event.new(name: 'Fete de Noël', description: 'Venez distribuer des cadeaux et animer une journée', address: '149 Rue de Sèvres, 75015 Paris', cause:  Event::EVENT_CAUSES[0], start_date:'Fri, 23 Dec 2022 13:00:00 +0100', end_date: 'Fri, 23 Dec 2022 19:00:00 +0100', number_volunteers: 8, asso: Asso.find_by(name: 'Petits Princes'))
...
sum_hours(event_5)
event_6 = Event.new(name: 'Fete de fin d année', description: 'Volontaires pour aider au bar à bonbons/boissons/gâteaux de la fête avant les grandes vacances' , address: '5 Pl. Paul Verlaine, 75013 Paris', cause:  Event::EVENT_CAUSES[0], start_date: 'Sat, 25 Jun 2022 18:30:00 +0100' , end_date: 'Sat, 25 Jun 2022 20:30:00 +0100', number_volunteers: 3, asso: Asso.find_by(name: 'Association Sportive et Culturelle de Montsouris'))
assign_photo_event(event_6, ["https://images.lanouvellerepublique.fr/image/upload/t_1020w/f_auto/5a289bf9479a45393f8b45a9.jpg"])
sum_hours(event_6)
event_7 = Event.new(name: 'Village Odysséa', description:'Besoin de volontaires pour aider dans la team organisation de la vie de l événement de la course Odysséa Paris', address:'2 Rte de la Ferme, 75012 Paris', cause:  Event::EVENT_CAUSES[4], start_date:'Sat, 1 Oct 2022 08:00:00 +0100', end_date:'Sun, 2 Oct 2022 20:00:00 +0100', number_volunteers: 100, asso: Asso.find_by(name: 'Odysséa'))
...
sum_hours(event_9)
event_10 = Event.new(name: "Maraude", description: 'distribution de repas', address: '10 bis Av. Trudaine, 75009 Paris', cause:  Event::EVENT_CAUSES[5], start_date:'Sat, 10 Dec 2022 18:00:00 +0100', end_date: 'Sat, 10 Dec 2022 23:00:00 +0100', number_volunteers: 20, asso: Asso.find_by(name: 'Secours Populaire de Paris'))
...
event_12 = Event.new(name: "Atelier vélo en famille", description: "Aidez des famille à apprendre le à rouler en vélo", address:' 1 Rue du Bac - Angle, Quai Voltaire, 75007 Paris', cause: Event::EVENT_CAUSES[2], start_date:'Sat, 15 Oct 2022 18:00:00 +0100', end_date: 'Sat, 15 Oct 2022 23:00:00 +0100', number_volunteers: 10, asso: Asso.find_by(name: 'Le Petit Biclou'))
...
event_13 = Event.new(name: 'Collecte de déchets', description: 'Nettoyer nos quais, départ depuis le lieu de rdv. Vous pouvez partir dès que votre sac est plein ;)', address:'Pl. Valhubert, 75000 Paris', cause: Event::EVENT_CAUSES[1], start_date:'Fri, 15 Jul 2022 14:00:00 +0100', end_date:'Fri, 15 Jul 2022 18:00:00 +0100', number_volunteers: 100, asso: Asso.find_by(name: 'Surfrider'))
